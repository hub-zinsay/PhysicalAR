...
namespace STYLY.Uploader
{
    public class Thumbnail : MonoBehaviour
    {
        ...
        /// Prefabのサムネイル画像作成
        /// </summary>
        /// <param name="assetPath">Prefabアセットパス</param>
        /// <param name="thumbnailPath">サムネイルファイル出力パス</param>
        ...
        /// シーンのサムネイル画像作成
        /// </summary>
        /// <param name="assetPath">シーンアセットパス</param>
        /// <param name="thumbnailPath">サムネイルファイル出力パス</param>
        public static void MakeThumbnailForScene(string assetPath, string thumbnailPath)
        {
            ...
            // 後処理
            // アクティブシーンとターゲットシーンが異なる場合はアクティブシーンを開く
        ...
        /// サムネイルをカメラで撮影して生成する
        /// </summary>
        /// <param name="camera">サムネイル撮影用カメラ</param>
        /// <param name="savePath">保存先の絶対パス</param>
        /// <param name="width">サムネイル画像の幅(px)</param>
        /// <param name="height">サムネイル画像の高さ(px)</param>
        /// <param name="successMake">成功か失敗か</param>
